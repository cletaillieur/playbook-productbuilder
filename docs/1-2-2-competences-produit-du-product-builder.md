...
![Visuel de proto-persona et story mapping utilisé pour cadrer les attentes utilisateurs d'un projet de data visualisation IA](assets/images/1-2-2-competences-produit-du-product-builder/proto-persona-story-mapping-1.webp)

![Second visuel de proto-persona et story mapping, complément du cadrage utilisateur](assets/images/1-2-2-competences-produit-du-product-builder/proto-persona-story-mapping-2.gif)
...
![Schéma de data lineage utilisé pour cartographier la disponibilité et la gouvernance des données du projet](assets/images/1-2-2-competences-produit-du-product-builder/data-lineage-analyse-donnees.webp)
